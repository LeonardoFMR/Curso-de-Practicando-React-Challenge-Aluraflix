...
function Colaborador({ titulo, color, onEditar, onEliminar }) {

    const vista = "https://api.thecatapi.com/api/images/get?format=src&ype=png"
        ...
        <>
            <div className={styles.container} style={{ border: `5px solid ${color}` }}>
                ...
                <div className={styles.iconos}>
                    <div className={styles.borrar} onClick={onEliminar}>
                        <img
                            src={borrar}
                            alt="Icono de borrar"
